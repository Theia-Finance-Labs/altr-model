...
# dependencies or instantiating catalog datasets. The catalog contains
# ibis.TableDataset BigQuery entries that hang on instantiation inside Cloud Run
# (no BigQuery connectivity), causing the PORT=4141 health check to time out.
