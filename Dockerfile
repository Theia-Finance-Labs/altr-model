...
# Launch Kedro Viz in --lite mode: skips importing project package and
# instantiating catalog datasets. Required because the catalog contains
# ibis.TableDataset BigQuery entries whose connection attempts at boot
# exceed the Cloud Run PORT=4141 startup probe window.
