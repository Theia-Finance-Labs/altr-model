...
| `company_ids` | `[]` | Scope filters | Empty list = all companies (no filter)<br>Values: list of company_id strings present in the companies input.<br>The full id list of the internal universe: see docs/handover/scenario_catalog.md |
